...
if (stickerpack.spackname == '') {
  var sticker_name = 'ツmomoᶻズガx'
  var sticker_author = '©BOT ツMOMOKズガx'
} else {
...
global.watermark = '© BOT ツLiaズガx ' //change the watermark (beberapa harus manual)
